#!/bin/bash -l
#SBATCH --job-name=shrek_tiny_arc1
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrek_tiny_arc1_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrek_tiny_arc1_%j.err
