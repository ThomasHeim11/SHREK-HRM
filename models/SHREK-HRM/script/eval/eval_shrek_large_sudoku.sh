#!/bin/bash -l
#SBATCH --job-name=eval_shrek_large_sudoku
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/eval_shrek_large_sudoku_%j.log
#SBATCH --error=/home/thheim/HMR/logs/eval_shrek_large_sudoku_%j.err
...
CKPT_DIR="checkpoints/Sudoku-extreme-1k-aug-1000-hint ACT-torch/shrek-large-sudoku-extreme"
