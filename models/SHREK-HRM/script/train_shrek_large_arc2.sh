#!/bin/bash -l
#SBATCH --job-name=shrek_large_arc2
#SBATCH --partition=gh200q
#SBATCH --gres=gpu:1
#SBATCH --output=/home/thheim/HMR/logs/shrek_large_arc2_%j.log
#SBATCH --error=/home/thheim/HMR/logs/shrek_large_arc2_%j.err
