...
CKPTS=$(python3 -c "prefix='checkpoints/Sudoku-extreme-1k-aug-1000-hint ACT-torch/HierarchicalReasoningModel_ACTV1 hopeful-quetzal/step_'; print(','.join([f'{prefix}{i*1302}' for i in range(24, 34)]))")
