...
class DataProcessConfig(BaseModel):
    # ARC-1
    #dataset_dirs: List[str] = ["raw-data/ARC-AGI/data", "raw-data/ConceptARC/corpus"]
    #output_dir: str = "data/arc-aug-1000"

    # ARC-2 — swap these two lines to build ARC-2 instead
    dataset_dirs: List[str] = ["raw-data/ARC-AGI-2/data"]
